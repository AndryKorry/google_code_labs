package com.vynokurov.dogglers

import android.content.Intent
import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import com.vynokurov.dogglers.databinding.DogglersActivityBinding

class DogglersActivity: AppCompatActivity() {

    private lateinit var binding: DogglersActivityBinding
    private lateinit var listIntent: Intent

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        // Setup view binding
        binding = DogglersActivityBinding.inflate(layoutInflater)
